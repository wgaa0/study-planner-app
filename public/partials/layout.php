...
<body class="bg-gray-100 flex">
    ...
    <aside class="w-64 h-screen bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-1 p-4 space-y-2">
            <a href="dashboard.php" class="block px-2 py-1 rounded hover:bg-gray-700">Dashboard</a>
            <a href="courses.php" class="block px-2 py-1 rounded hover:bg-gray-700">Courses</a>
            <a href="tasks.php" class="block px-2 py-1 rounded hover:bg-gray-700">Tasks</a>
